...
import FooterSocialLinks from "@/components/home/FooterSocialsLinks";
  ...
  return (
    <footer className="bg-black overflow-hidden">
      ...
      <div className="max-w-380 mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row flex-wrap lg:justify-between gap-6 max-w-380 w-full">
          <svg
            width="209"
            height="18"
            viewBox="0 0 209 18"
          ...
          <div className="flex lg:flex-row max-w-252.5 w-full">
        ...
        <div className="flex flex-wrap flex-col md:flex-row justify-between gap-6 py-3 lg:pt-24 lg:pb-16.25 w-full">
